...
| **Claremont** | 26 | Yes, via a FinalSite JS modal (`a.fsConstituentProfileLink`) | 24/26 | 8/26 | 0/26 | MEDIUM | Same modal system as Austin. Degrees came through the modal cleanly; publications did not — the modal may not surface them, or the harvest didn't look past degrees once it found them. |
