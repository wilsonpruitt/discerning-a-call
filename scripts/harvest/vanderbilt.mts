...
function buildProfile(): SeminaryProfile {
  ...
  return {
    ...
    ordination: {
      ...
      gapSummary: "Vanderbilt's relationship to ¶324.4 is genuinely different from every other non-UMC school this project has looked at, and the difference matters more than the raw 4-of-9 number suggests. Brite (also non-UMC) says outright that its United Methodist history/doctrine/mission/polity courses have been officially approved by denominational offices, and names a chair whose title says 'Methodist Studies.' Duke and Phillips (a UMC school and a monitored non-UMC school) both write, in their own bulletins, that a United Methodist ordination-track student MUST complete specific named courses. Vanderbilt does none of the three. It has real Wesleyan/Methodist infrastructure — two Cal Turner Chancellor's Chairs in Wesleyan Studies (Joerg Rieger and James P. Byrd, both UMC-ordained), three named United Methodist courses, a United Methodist Studies programme dating to 1985, a new Turner-Barnett Program for Pastoral Formation mentored by a retired UMC bishop, and a full-tuition scholarship reserved for a UMC ordination candidate (below). What it does not have, on its own published pages, is any statement that a United Methodist student is bound to take that coursework, or that the coursework carries denominational approval for ¶324.4 purposes. Five of the nine areas — evangelism, mission of the church, worship, preaching, and United Methodist studies itself — are yours to plan for deliberately, the way a UMC candidate at any purely ecumenical school would have to, not something the degree structure hands you.",
      gapRemedies: [
        {
