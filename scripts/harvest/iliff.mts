...
function buildProfile(): SeminaryProfile {
  ...
  return {
    ...
    ordination: {
      ...
      gapSummary: [
        "All nine ¶324.4 areas bind a United Methodist candidate at Iliff — there is no area left uncovered. But none of the nine sit in Iliff's own denomination-neutral MDiv core: Iliff's current marketing pages describe the 72-credit MDiv as concentration-based and publish no course-level requirements at all, so the obligation for every one of the nine exists only because of Iliff's own United Methodist Church page, which states it in binding language and was built “in consultation with” GBHEM.",
        "That page was last substantively updated in 2022, three years before Iliff's Fall 2025 curriculum redesign (the 72-credit, concentration-based MDiv now in effect). Every course this page names for history, worship, and UM studies was checked by hand against Iliff's current 2025–2026 catalog: seven of the nine areas' courses were confirmed current by name and code (two with course numbers changed since 2022, still covering the same ground); the worship course could not be confirmed by name at all, and the history course's own catalog description appears to describe preaching rather than history.",
        "None of this changes the underlying ¶324.4 obligation — it changes how much a candidate should treat the school's own summary page as the last word, versus a lead to confirm.",
      ],
      gapRemedies: [
        {
